...
import 'package:bus_ticket/screens/select_seat.dart';
...
class _DetailScreenState extends State<DetailScreen> {
  ...
  Widget build(BuildContext context) {
    double total = widget.bus.price * _count;
    return Scaffold(
                  ...
                  onPressed: () {
                    Navigator.of(context).pushReplacement(MaterialPageRoute(
                        builder: (context) => ChooseSeat(
                              ticket_price: widget.bus.price,
                              totalSeat: widget.bus.set,
                              bus: widget.bus
                            )));
                  },
